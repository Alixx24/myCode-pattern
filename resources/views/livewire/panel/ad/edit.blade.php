<div>
    <div>
        ...
        <section>
        <form action="{{ route('panel.users.ads.update', $ad->id) }}" method="POST" enctype="multipart/form-data" id="form">
                    @csrf
                    {{ method_field('put') }}
                <p>id = {{ $ad->id }}</p>
                <section class="col-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="title" value="{{ old('title', $ad->title) }}">
                    </div>
                    @error('title')
                ...
                <section class="col-12">
                    <section class="form-group">
                        ...
                        <textarea class="summernote" name="description" id="description" rows="5" placeholder="description ...">{{ old('description', $ad->description) }}</textarea>
                    </section>
                    @error('description')
                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                        <strong>
