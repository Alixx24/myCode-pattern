            ...
            <section class="d-md-flex justify-content-md-between align-items-md-center py-3">
                    ...
                    <section class="search-box">
                        <section class="search-textbox">
                            ...
                            <form action="" method="get">
                                <input id="search" type="text" class="" name="search" value="" placeholder="جستجو ..." autocomplete="off">
                            </form>
                        </section>
                ...
                <section class="mt-3 mt-md-auto text-end">
                    <section class="d-inline px-md-3">
                        ...
                        @guest
                        <a href="{{ route('register') }}" class="btn btn-link text-decoration-none text-dark profile-button">
                    ...
                    <section class="header-cart d-inline ps-3 border-start position-relative">
                        <a class="btn btn-link position-relative text-dark header-cart-link" href="">
                            <i class="fa fa-shopping-cart"></i> <span style="top: 80%;" class="position-absolute start-0 translate-middle badge rounded-pill bg-danger"></span>
                        </a>
                        <section class="header-cart-dropdown">
                            <section class="border-bottom d-flex justify-content-between p-2">
                                <span class="text-muted"> کالا</span>
                            ...
                            <section class="header-cart-dropdown-body">
                                ...
                                <section class="header-cart-dropdown-body-item d-flex justify-content-start align-items-center">
                                    <img class="flex-shrink-1" src="" alt="">
                                    <section class="w-100 text-truncate"><a class="text-decoration-none text-dark" href=""></a></section>
        ...
        <section class="container-xxl ">
            <nav class="">
                <section class="d-none d-md-flex justify-content-md-start position-relative">
                    ...
                    <section class=" my-2 mx-1"></section>
                    @foreach ($menus as $menu)

                    <section class="navbar-item" id="about"><a href="{{ urldecode($menu->url) }}" style="color:white">{{ $menu->name }}</a></section>
